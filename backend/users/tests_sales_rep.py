...
class SalesRepFunctionalTestCase(APITestCase):
    ...
    def test_owner_can_update_rep_target(self):
        ...
        member = TeamMember.objects.create(owner=self.owner, business=self.business, user=self.rep_user, role='SALES_REP')
    ...
    def test_sales_rep_can_update_location(self):
        ...
        TeamMember.objects.create(owner=self.owner, business=self.business, user=self.rep_user, role='SALES_REP')
        self.client.force_authenticate(user=self.rep_user)
    ...
    def test_unauthorized_role_cannot_invite(self):
        ...
        TeamMember.objects.create(owner=self.owner, business=self.business, user=accountant_user, role='ACCOUNTANT')
    ...
    def test_manager_can_invite_rep(self):
        ...
        TeamMember.objects.create(owner=self.owner, business=self.business, user=manager_user, role='MANAGER')
